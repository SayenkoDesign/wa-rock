...
class WP_List_Table_Helper extends WP_List_Table {
	...
	<div class="row">
	<div class="col-md-12">
	<div class="WPUAP_menu_title">
	<h4 class="alert alert-info"><?php _e( 'Manage '.ucwords( $this->plural_label ), $this->textdomain );?><a style='float:right' target='_blank' href='http://codecanyon.net/downloads'>Rate Me - <img src='<?php echo WPUAP_IMAGES ?>rating.png' /></a></h4>
</div>
